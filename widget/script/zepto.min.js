/* Zepto 1.1.3 - zepto event - zeptojs.com/license */
var Zepto = function () {
    function L(t) {
        return null == t ? String(t) : N[C.call(t)] || "object"
    }
    ...
    function M(t) {
        return k(t) && !j(t) && Object.getPrototypeOf(t) == Object.prototype
    }
    ...
    function H(n, i, r) {
        for (e in i)r && (M(i[e]) || $(i[e])) ? (M(i[e]) && !M(n[e]) && (n[e] = {}), $(i[e]) && !$(n[e]) && (n[e] = []), H(n[e], i[e], r)) : i[e] !== t && (n[e] = i[e])
    }
    ...
    var t, e, n, i, P, S, r = [], o = r.slice, s = r.filter, u = window.document, f = {}, a = {}, c = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, l = /^\s*<(\w+|!)[^>]*>/, h = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, p = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, d = /^(?:body|html)$/i, g = /([A-Z])/g, m = ["val", "css", "html", "text", "data", "width", "height", "offset"], v = ["after", "prepend", "before", "append"], y = u.createElement("table"), b = u.createElement("tr"), w = {
        ...
        th: b,
        "*": u.createElement("div")
    }, E = /complete|loaded|interactive/, x = /^[\w-]*$/, N = {}, C = N.toString, O = {}, T = u.createElement("div"), A = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    return O.matches = function (t, e) {
        ...
        return o && (r = T).appendChild(t), i = ~O.qsa(r, e).indexOf(t), o && T.removeChild(t), i
    }, P = function (t) {
        ...
        var s, f, a;
        return h.test(e) && (s = n(u.createElement(RegExp.$1))), s || (e.replace && (e = e.replace(p, "<$1></$2>")), i === t && (i = l.test(e) && RegExp.$1), i in w || (i = "*"), a = w[i], a.innerHTML = "" + e, s = n.each(o.call(a.childNodes), function () {
            a.removeChild(this)
        })), M(r) && (f = n(s), n.each(r, function (t, e) {
            m.indexOf(t) > -1 ? f[t](e) : f.attr(t, e)
        })), s
    }, O.Z = function (t, e) {
        ...
        var r;
        if (!e)return O.Z();
        if ("string" == typeof e)if (e = e.trim(), "<" == e[0] && l.test(e))r = O.fragment(e, RegExp.$1, i), e = null; else {
            if (i !== t)return n(i).find(e);
            r = O.qsa(u, e)
        } else {
            if (Z(e))return n(u).ready(e);
            if (O.isZ(e))return e;
            if ($(e))r = D(e); else if (k(e))r = [e], e = null; else if (l.test(e))r = O.fragment(e.trim(), RegExp.$1, i), e = null; else {
                if (i !== t)return n(i).find(e);
                r = O.qsa(u, e)
            }
        }
        ...
        var n, i = "#" == e[0], r = !i && "." == e[0], s = i || r ? e.slice(1) : e, u = x.test(s);
        return _(t) && u && i ? (n = t.getElementById(s)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : o.call(u && !i ? r ? t.getElementsByClassName(s) : t.getElementsByTagName(e) : t.querySelectorAll(e))
    }, n.contains = function (t, e) {
        return t !== e && t.contains(e)
    }, n.type = L, n.isFunction = Z, n.isWindow = j, n.isArray = $, n.isPlainObject = M, n.isEmptyObject = function (t) {
        var e;
        for (e in t)return !1;
        return !0
        ...
        not: function (e) {
            ...
            if (Z(e) && e.call !== t)this.each(function (t) {
                ...
                var r = "string" == typeof e ? this.filter(e) : z(e) && Z(e.item) ? o.call(e) : n(e);
        ...
        closest: function (t, e) {
            var i = this[0], r = !1;
            for ("object" == typeof t && (r = n(t)); i && !(r ? r.indexOf(i) >= 0 : O.matches(i, t));)i = i !== e && !_(i) && i.parentNode;
            return n(i)
        },
        parents: function (t) {
        ...
        parent: function (t) {
            return J(S(this.pluck("parentNode")), t)
        },
        children: function (t) {
        ...
        attr: function (n, i) {
            ...
            return "string" == typeof n && i === t ? this.length && 1 === this[0].nodeType ? !(r = this[0].getAttribute(n)) && n in this[0] ? this[0][n] : r : t : this.each(function (t) {
                if (1 === this.nodeType)if (k(n))for (e in n)X(this, e, n[e]); else X(this, n, U(this, i, t, this.getAttribute(n)))
            })
        },
        ...
        prop: function (e, n) {
            return e = A[e] || e, n === t ? this[0] && this[0][e] : this.each(function (t) {
                this[e] = U(this, n, t, this[e])
            })
        },
        data: function (e, n) {
            var i = this.attr("data-" + e.replace(g, "-$1").toLowerCase(), n);
            return null !== i ? W(i) : t
        },
        val: function (t) {
            return 0 in arguments ? this.each(function (e) {
        ...
        offset: function (t) {
            if (t)return this.each(function (e) {
                var i = n(this), r = U(this, t, e, i.offset()), o = i.offsetParent().offset(), s = {
                    top: r.top - o.top,
                    left: r.left - o.left
                };
        ...
        css: function (t, i) {
            if (arguments.length < 2) {
                ...
                if ($(t)) {
                    var s = {};
                    return n.each($(t) ? t : [t], function (t, e) {
                        s[e] = r.style[P(e)] || o.getPropertyValue(e)
                    }), s
                }
            }
            var u = "";
            if ("string" == L(t))i || 0 === i ? u = q(t) + ":" + R(t, i) : this.each(function () {
                this.style.removeProperty(q(t))
            }); else for (e in t)t[e] || 0 === t[e] ? u += q(e) + ":" + R(e, t[e]) + ";" : this.each(function () {
        ...
        removeClass: function (e) {
            return this.each(function (n) {
                return e === t ? Y(this, "") : (i = Y(this), U(this, e, n, i).split(/\s+/g).forEach(function (t) {
                    i = i.replace(F(t), " ")
                }), void Y(this, i.trim()))
            })
        },
        toggleClass: function (e, i) {
            return e ? this.each(function (r) {
                var o = n(this), s = U(this, e, r, Y(this));
        ...
        n.fn[e] = function (r) {
            var o, s = this[0];
            return r === t ? j(s) ? s["inner" + i] : _(s) ? s.documentElement["scroll" + i] : (o = this.offset()) && o[e] : this.each(function (t) {
                s = n(this), s.css(e, U(this, r, t, s[e]()))
            })
        }
        ...
        n.fn[t] = function () {
            var t, o, r = n.map(arguments, function (e) {
                return t = L(e), "object" == t || "array" == t || null == e ? e : O.fragment(e)
            }), s = this.length > 1;
            return r.length < 1 ? this : this.each(function (t, f) {
                o = i ? f : f.parentNode, f = 0 == e ? f.nextSibling : 1 == e ? f.firstChild : 2 == e ? f : null;
                var a = u.documentElement.contains(o);
                r.forEach(function (t) {
                    if (s)t = t.cloneNode(!0); else if (!o)return n(t).remove();
                    o.insertBefore(t, f), a && G(t, function (t) {
    ...
    }), O.Z.prototype = n.fn, O.uniq = S, O.deserializeValue = W, n.zepto = O, n
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    t.fn.delegate = function (t, e, n) {
    ...
    }, t.fn.on = function (e, s, u, f, a) {
        var c, l, h = this;
        return e && !o(e) ? (t.each(e, function (t, e) {
            h.on(t, s, u, e, a)
        }), h) : (o(s) || r(f) || f === !1 || (f = u, u = s, s = n), (r(u) || u === !1) && (f = u, u = n), f === !1 && (f = w), h.each(function (n, r) {
            a && (c = function (t) {
                return y(r, t.type, f), f.apply(this, arguments)
            }), s && (l = function (e) {
                var n, o = t(e.target).closest(s, r).get(0);
                return o && o !== r ? (n = t.extend(C(e), {
                    currentTarget: o,
                    liveFired: r
                }), (c || f).apply(o, [n].concat(i.call(arguments, 1)))) : void 0
            }), v(r, e, f, u, s, l || c)
        }))
        ...
        return e && !o(e) ? (t.each(e, function (t, e) {
            u.off(t, i, e)
        }), u) : (o(i) || r(s) || s === !1 || (s = i, i = n), s === !1 && (s = w), u.each(function () {
            y(this, e, s, i)
        }))
    }, t.fn.trigger = function (e, n) {
        return e = o(e) || t.isPlainObject(e) ? t.Event(e) : N(e), e._args = n, this.each(function () {
            "dispatchEvent" in this ? this.dispatchEvent(e) : t(this).triggerHandler(e, n)
        })
    }, t.fn.triggerHandler = function (e, n) {
        var i, r;
        return this.each(function (s, u) {
            i = C(o(e) ? t.Event(e) : e), i._args = n, i.target = u, t.each(h(u, e.type || e), function (t, e) {
